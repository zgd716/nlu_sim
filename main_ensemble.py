...
from siamese_network_predict import *
...
def process(inpath, outpath):
    ...
    #
    #
    # jellyzhang 20180524  引入siamese network
    logits_siamese, line_no_list, vocab_index2label=predict_siamese(inpath)

    # # 2. get weighted logits
    # logits=logits_mix_word +logits_mix_char +logits_cnn_char
    logits=logits_siamese
